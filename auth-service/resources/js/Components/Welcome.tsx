    ...
    <div>
      <div className="p-6 lg:p-8 bg-white border-b border-gray-200">
        ...
        <h1 className="mt-8 text-2xl font-medium text-gray-900">
          {t('welcome.title', 'Welcome to TekRem ERP System!')}
        </h1>

        <p className="mt-6 text-gray-500 leading-relaxed">
          {t('welcome.description', 'TekRem ERP provides a comprehensive solution for managing your business operations. This system is designed to help you streamline your workflows, improve efficiency, and make better business decisions with powerful tools and insights.')}
        </p>
      </div>
